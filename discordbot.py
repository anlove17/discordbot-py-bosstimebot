...
BOSS_INFO = {
    ...
    '부요부요' : { '젠주기': 300,'젠위치': '축제 행사장', '레벨':50, '다음 젠 시간' : '??:??'  },
    '아무르' : { '젠주기': 300,'젠위치': '돌염전 지대', '레벨':50, '다음 젠 시간' : '??:??'  },
    '칼비오레' : { '젠주기': 300,'젠위치': '브레드 농장', '레벨':50, '다음 젠 시간' : '??:??'  },
    '머라이어' : { '젠주기': 300,'젠위치': '조개무덤', '레벨':50, '다음 젠 시간' : '??:??'  },
    '게란타' : { '젠주기': 300,'젠위치': '돌무덤 초소', '레벨':50, '다음 젠 시간' : '??:??'  }
}
